...
Alternatively you can upload `wp-quick-image.zip` from Plugins -> Add New -> Upload Plugin
...
1. The "Quick Image" widget on the WordPress dashboard.
2. A populated widget showing a preview image.
