    ...
    <form method="post" action="options.php">
        ...
        <tr valign="top">
          ...
          <td><label for="rwp_upload_image">
            ...
            <td><input type="checkbox" name="rwp_remove_comp_dashboards" value="1" <?php echo $rem_chkysno; ?> />*Hide these if you are adding widgets of your own (Below or with seperate plugin).</td>
            </tr>
