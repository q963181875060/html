...
class Metronet_Profile_Picture	{	
	...
	*/
	public function insert_upload_form() {
		...
		?>
		<tr valign="top">
			<th scope="row"><?php esc_html_e( "头像", "metronet-profile-picture" ); ?></th>
			<td id="mpp">
	...
	**/
	public function print_media_scripts() {
		...
		wp_localize_script( 'mt-pp', 'metronet_profile_image', 
			array( 
				'set_profile_text' => __( '设置头像', 'metronet-profile-picture' ),
				'remove_profile_text' => __( '删除头像', 'metronet-profile-picture' ),
